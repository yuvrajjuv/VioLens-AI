...
export const buttonVariantsOuter = cva("", {
  variants: {
    variant: {
      primary:
      ...
      outline:
        "w-full border-2 border-neutral-200 dark:border-neutral-800 bg-transparent hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors",
      ghost:
        "w-full hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors",
  ...
  "w-full h-full flex items-center justify-center text-muted-foreground",
  {
    variants: {
      variant: {
        ...
        outline:
          "bg-transparent text-sm text-foreground hover:text-foreground transition-colors",
        ghost:
          "bg-transparent text-sm text-foreground hover:text-foreground transition-colors",
